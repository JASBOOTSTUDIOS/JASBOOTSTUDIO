...
- Implementación por fases del grafo `n_*` (tabla de seguimiento interna): monorepo `docs/PROYECTO/CHECKLIST_CONCEPTOS_OPTIMIZADOS_V1.md`.
- Coexistencia memoria/grafo: [coexistencia-memoria-n-grafo.md](coexistencia-memoria-n-grafo.md)
- Formato .ngf: [spec-formato-ngf-v1.md](spec-formato-ngf-v1.md)
