...
Catálogo centralizado de errores del lenguaje y criterios para mensajes consistentes en español, sin depender de mensajes de C/host. Complementa el [contrato de runtime](contrato-runtime-v1.md). Criterios de producto de más alto nivel pueden vivir solo en documentación interna del monorepo.
...
**Referencia:** [contrato-runtime-v1.md](contrato-runtime-v1.md).  
