...
- *Roadmap detallado por fases (self-hosting en .jasb) y tablas de seguimiento:* solo en el monorepo local, `docs/PROYECTO/CHECKLIST_ROADMAP_JASBOOT.md` y afines.
