...
Operaciones sobre conceptos (crear/leer/actualizar/olvidar) y tipos de error que puede devolver el runtime. Otros documentos de diseño (`MODELO_SEMANTICO_V1.0.md`, planes de producto) pueden existir solo en el monorepo local.
...
**Relacionado:** [catálogo de errores](catalogo-errores-v1.md) (Nivel 1.5).  
