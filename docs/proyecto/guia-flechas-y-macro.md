...
Referencia corta para escribir y revisar tests **y** para interpretar mensajes del compilador (`jbc`). En el monorepo de desarrollo, la batería asociada está en `tests/P1_12_funciones_flecha/` (ver su `README.md`); el orden maestro de construcciones y tests se mantiene en documentación interna (`docs/PROYECTO/CHECKLIST_INSTRUCCIONES_JASBOOT_CATALOGO_TESTS.md`), no en este repositorio público.
...
- Tests y notas (monorepo local): `tests/P1_13_llamar_funcion/README.md`.
